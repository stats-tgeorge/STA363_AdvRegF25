...
3.  What options can you think of for handling the fact that Period 5 is based on only 2 lunar days? What are the modeling implications of including the number of days in a period as an offset term?

4.  Interpret model parameters from **fit1**.

5.  Is there any evidence of a lack of fit in **fit1**? What factors may lead to a lack of fit?

6.  Does the full moon have an effect above and beyond the linear cycle trend? Interpret the coefficient and a 95% confidence interval for the *fullmoon* term in **fit3**.

7.  What is **fit4** doing? Does it offer an improvement over **fit3**?

8.  Compare **fit5** to the analysis in the original author's paper. Are they the same? Discuss. See the article[ HERE](https://www.bmj.com/content/321/7276/1559.long).
...
10. Is there evidence of a lack of fit in **fit5**? Cite evidence both from a goodness of fit test and from comparing means and variances by period.

11. If overdispersion goes uncorrected, what are the implications for p-values and CIs for model coefficients?
