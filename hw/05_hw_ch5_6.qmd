...
b.  For quantitative explanatory variables (`age`, `yrsmoke`, `cigsday`), produce a *cdplot's* (conditional density plots, ggridges2 can do this), a boxplot, and summary statistics by cancer diagnosis.
