---
title: Homework 5
subtitle: 'Ch 5 & 6: GLMs and Logistic'
---
...
b.  For quantitative explanatory variables (`age`, `yrsmoke`, `cigsday`), produce a *cdplot's* (conditional density plots, `geom_density_ridges2()` from *ggridges* can do this), a boxplot, and summary statistics by cancer diagnosis.
...
When you are finished with your homework, be render the final document. Once rendered, you can download your file by:
